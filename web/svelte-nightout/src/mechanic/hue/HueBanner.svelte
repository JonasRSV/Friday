...
<Container fluid class="container-keywords">
  <Row class="text-center" > 
    <div class="banner text-dark"> 
      <div class="vertical-center banner-text"> Philips Hue </div> 
    </div> 
  </Row>
</Container>
